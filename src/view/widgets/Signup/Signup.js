...
const initData = {
    ...
    content: "Your account is created based on your connected wallet address."
}
...
class Signup extends Component {
    ...
    async checkWeb3() {
        if (window.web3.isConnected()) {
            ...
            // Hacemos la vaina de address en el state
            this.setState({
                address: window.web3.eth.accounts[0]
            })
        } else {
            // Connecta web3 y hace la vaina de address en el state
            await connectWallet();
            this.setState({
                address: window.web3.eth.accounts[0]
            });
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        <button className="btn w-100 mt-3 mt-sm-4" type="submit" onClick={() => {
                                            if (!this.state.hasClickedPrivacy) {
